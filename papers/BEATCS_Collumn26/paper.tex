...
The syntax of flag algebra consists of two types of expressions: \emph{density expressions} $E$ and \emph{assertions} $A$. Density expressions denote real numbers obtained from the densities of pattern graphs in a limiting density map, while assertions denote truth values obtained from comparisons between density expressions. Formally, the syntax is defined as follows.
\begin{align*}
\text{Density Expressions}\quad E & ::= 0 \,\mid\, 1 \,\mid\, H \,\mid\, r \cdot E \,\mid\, E + E \,\mid\, E \times E
\\
\text{Assertions}\quad A & ::= \lfalse \,\mid\, \ltrue \,\mid\, E \geq E \,\mid\, A \,\mid\, A \lor A 
\end{align*}
