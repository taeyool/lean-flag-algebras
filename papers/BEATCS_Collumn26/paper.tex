...
Using this logic, we can express various properties of limiting graphs. For instance, we can express that if a limiting graph $\phi$ is triangle-free, then the edge density of $\phi$ is at most $1/2$ as follows:
\[
K_3 = 0 \Rightarrow K_2 \leq \tfrac{1}{2}.
\]
This is a version of the well-known Mantel's theorem for limiting graphs \hy{Citation}.
