...
\]
The optimal $c$ here is known to be $1/2$ by Mantel's theorem. We prove the bound in the flag-algebra logic as follows. We start by noting that the next bound holds:
\[
0 \leq \tfrac{1}{2} \cdot \Ithree - \tfrac{1}{6} \cdot \Ethree - \tfrac{1}{6} \cdot \Pthree
+ \tfrac{3}{2} \cdot \Kthree
\]
Using the inequality and the assumption $K_3 = 0$, we prove the desired inequality
as follows: 
\begin{align*}
  K_2 
...
+ \tfrac{3}{2} \cdot \Kthree\right)
  \\
  & = \tfrac{1}{2} \cdot \Ithree + \tfrac{1}{6} \cdot \Ethree + \tfrac{1}{2} \cdot \Pthree + \tfrac{5}{2} \cdot \Kthree
  \\
