...
\]
where $\mathbf{U}$ is a uniform random subset of $V(G') \setminus \theta'([k])$ with size $v(H') - k$. \hy{Explain $\tau$-labeled limiting graphs.}
