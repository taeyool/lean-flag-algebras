...
\end{align*}
where $G$ is a graph, and $r \in \mathbb{R}$. Denity expressions are built from pattern graphs using real scalar multiplication, addition, multiplication, and the constants $0$ and $1$. Assertions are built from the boolean constants $\lfalse$ and $\ltrue$, comparisons between density expressions, negation, and disjunction. The negation and disjunction have the usual meanings in classical logic. As a result, they induce other logical connectives such as conjunction and implication in the standard way.
