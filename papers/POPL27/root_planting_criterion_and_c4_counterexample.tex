...
asks that an inequality hold almost surely along the random labelings of limits of
unlabelled constrained graphs.  Quotient
...
condition, which we call \emph{root-plantability}, holds: every limit of labelled constrained graphs
must be approximable by rooted views of limits of unlabelled constrained graphs. Closure under
independent blow-ups (which holds for clique-free and triangle-free theories) implies root-plantability and ensures that these two notions of non-negativity coincide. But heredity alone does not lead to root-plantability.  Every class so
