...
flag appearing in the product of a flag outside \(\mathcal K\) with another
flag contains the first flag as an induced subflag.  It therefore also lies
outside \(\mathcal K\), since otherwise heredity would put that induced subflag
...
\(Q_0:=Q_{\emptyt}\) for the corresponding space of constrained empty-type
