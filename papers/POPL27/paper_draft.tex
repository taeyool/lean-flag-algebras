...
Mantel's theorem and the Erd\H{o}s pentagon theorem, a bound on the
$C_4$-density of triangle-free graphs, and edge-density bounds for
$K_4$-free, $K_5$-free, and $C_5$-free graphs.  Outside the certificate
pipeline, the same formalization is used directly: it proves the matching
lower bounds for the Mantel and Erd\H{o}s pentagon theorems, and two
inequalities of Goodman.  We
also summarized a separately developed
...
We would like to thank Taeyoung Kim, Joonkyung Lee, Jineon Baek, and Hyunwoo Lee for helpful discussions on
