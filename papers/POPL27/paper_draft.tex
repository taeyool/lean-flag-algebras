...
\begin{lstlisting}
def labeledGraphListEqv {(*@$\sigma$@*) : FlagType T} {t : (*@$\mathbb{N}$@*)} {Vl : Fin t (*@$\to$@*) Type}
    (Gl Gl' : LabeledGraphList (*@$\sigma$@*) t Vl) : Prop :=
  (*@$\forall$@*) (i : Fin t), Nonempty (Gl i (*@$\simeq$@*)f Gl' i)

instance labeledGraphListSetoid ((*@$\sigma$@*) : FlagType T) (t : (*@$\mathbb{N}$@*)) (Vl : Fin t (*@$\to$@*) Type)
...
for each \lean{i : Fin t}.  The term \lean{Fl.coe} has type
...
\lean{flagListDensity} can call \lean{quotLabeledGraphListDensity} after
converting the tuple-of-flags input into the quotient-of-tuples input expected
