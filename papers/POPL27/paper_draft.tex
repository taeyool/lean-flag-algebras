...
\begin{table}[h]
  ...
  \begin{tabular}{lccrr}
    ...
    \midrule
    Mantel ($K_2$, induced route)    & $K_3$ & 3 &    15 &       $12^\dagger$ \\
    Mantel ($K_2$, H-free route)     & $K_3$ & 3 &    15 &       $14^\dagger$ \\
    $P_3$ density                    & $K_3$ & 3 &    15 &       $19^\dagger$ \\
    $C_4$ density                    & $K_3$ & 4 &   210 &       $91^\dagger$ \\
    Edge density ($K_4$-Tur\'an)     & $K_4$ & 4 &   390 &      $132^\dagger$ \\
    \midrule
    Erd\H{o}s pentagon ($C_5$)       & $K_3$ & 5 &  2832 & $124^\ddagger$ / $2781^\dagger$ \\
    Edge density ($K_5$-Tur\'an)     & $K_5$ & 5 & 10332 &      $346^\ddagger$ \\
    Edge density ($C_5$-free)        & $C_5$ & 5 &  8172 &      $540^\ddagger$ \\
    \bottomrule
  \end{tabular}
\end{table}
