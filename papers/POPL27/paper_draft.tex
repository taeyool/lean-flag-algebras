...
\caption{Certificates carried end-to-end through the compiler.  \(H\) is the
  forbidden graph, \(N\) the host size, \(n_F\) the number of vertices of the
  target graph \(F\), and \(T\) the number of SDP blocks.}
  \label{tab:flagmatic-scenarios}
  \begin{tabular}{lccccc}
    \toprule
    Case & $H$ & $N$ & $n_F$ & $T$ & Bound \\
    \midrule
    Mantel (edge density)               & $K_3$ & 3 & 2 & 1 & $1/2$    \\
    $P_3$ density                       & $K_3$ & 3 & 3 & 1 & $3/4$    \\
    $C_4$ density                       & $K_3$ & 4 & 4 & 2 & $3/8$    \\
    Edge density                        & $K_4$ & 4 & 2 & 2 & $2/3$    \\
    Erd\H{o}s pentagon ($C_5$ density)  & $K_3$ & 5 & 5 & 3 & $24/625$ \\
    Edge density                        & $K_5$ & 5 & 2 & 4 & $3/4$    \\
    Edge density                        & $C_5$ & 5 & 2 & 4 & $1/2$    \\
    \bottomrule
  \end{tabular}
\end{table}
...
all with~$8\times8$ matrices.  Together, these examples exercise targets both
