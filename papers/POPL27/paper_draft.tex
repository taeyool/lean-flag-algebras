...
homomorphisms.  The relevant construction lives in
\lean{FlagAlgebra/RandomHom.lean}.  Given an empty-type positive homomorphism
...
\(\phi_0(\llbracket 1\rrbracket_0)\).  This is exactly the bridge needed for
...
non-negative, and so the average is non-negative.  This is the formal bridge
