...
\begin{lstlisting}
structure LabeledGraphIso {T V W : Type} [Fintype T] ((*@$\sigma$@*) : FlagType T)
    (G : LabeledGraph (*@$\sigma$@*) V) (G' : LabeledGraph (*@$\sigma$@*) W) where
  graph_iso     : G.graph (*@$\simeq$@*)g G'.graph
  type_preserve : graph_iso (*@$\circ$@*) G.type_embed = G'.type_embed

infixl:50 " (*@$\simeq$@*)f " => LabeledGraphIso

def flagEqv {T V : Type} [Fintype T] ((*@$\sigma$@*) : FlagType T)
    (G G' : LabeledGraph (*@$\sigma$@*) V) : Prop :=
  Nonempty (LabeledGraphIso (*@$\sigma$@*) G G')
...
The next definition, \lean{flagEqv}, turns labeled-graph isomorphism into a
proposition: two terms $G,G'$ of type
\lean{LabeledGraph}~$\sigma$~\lean{V} are equivalent if there exists a
label-preserving graph isomorphism between them.  Thus $G\simeq_f G'$ is the
type of isomorphism data, while \lean{flagEqv G G'} is the proposition that
such data exists.  Lean's quotient type does not take an arbitrary relation
directly; it expects a \emph{setoid}, namely a type together with an explicitly
supplied equivalence relation.  The instance
\lean{labeledGraphSetoid} provides this package for
\lean{LabeledGraph}~$\sigma$~\lean{V}.  Its field \lean{r} is the relation
\lean{flagEqv}, and its field \lean{iseqv} contains the proofs that this
...
enumeration and equality tests needed for counting.  The typeclasses
\lean{FintypeList Vl} and \lean{DecidableEqList Vl} are componentwise versions
of \lean{Fintype} and \lean{DecidableEq}: they supply those instances for each
vertex type \lean{Vl i} in the tuple.
...
\begin{lstlisting}
def labeledGraphListEqv {T : Type} [Fintype T]
    ((*@$\sigma$@*) : FlagType T) {t : (*@$\mathbb{N}$@*)} {Vl : Fin t (*@$\to$@*) Type}
    (Gl Gl' : LabeledGraphList (*@$\sigma$@*) t Vl) : Prop :=
...
instance labeledGraphListSetoid {T : Type} [Fintype T]
  ...
  iseqv := ... -- proofs that entrywise isomorphism is an equivalence
...
noncomputable def FlagList.coe {T : Type} [Fintype T]
...
noncomputable def flagDensity(*@$_2$@*)
    {T U(*@$_1$@*) U(*@$_2$@*) W : Type} [Fintype T]
    [Fintype U(*@$_1$@*)] [DecidableEq U(*@$_1$@*)] [Fintype U(*@$_2$@*)] [DecidableEq U(*@$_2$@*)]
    [Fintype W] [DecidableEq W]
    ((*@$\sigma$@*) : FlagType T)
    (F(*@$_1$@*) : Flag (*@$\sigma$@*) U(*@$_1$@*)) (F(*@$_2$@*) : Flag (*@$\sigma$@*) U(*@$_2$@*)) (G : Flag (*@$\sigma$@*) W) : (*@$\mathbb{Q}$@*) :=
  flagListDensity (*@$\sigma$@*) [F(*@$_1$@*), F(*@$_2$@*)](*@$^\mathtt{f}$@*) G
\end{lstlisting}
Here the superscripted bracket notation is only a tuple constructor for
...
algebra expressions.\footnote{In the Lean source, the intermediate size
\(\ell'\) is an explicit argument mainly for convenience: when applying the
chain rule, one often chooses the size of the intermediate flag directly.}
\begin{lstlisting}
theorem flagDensity_eq_sum_density_prods
    {(*@$\ell_0$@*) (*@$\ell_1$@*) (*@$\ell$@*) (*@$\ell'$@*) : (*@$\mathbb{N}$@*)}
    ((*@$\sigma$@*) : FlagType (Fin (*@$\ell_0$@*)))
    (F(*@$_1$@*) : Flag (*@$\sigma$@*) (Fin (*@$\ell_1$@*))) (G : Flag (*@$\sigma$@*) (Fin (*@$\ell$@*)))
    (h(*@$\ell_1$@*) : (*@$\ell_0$@*) (*@$\leq$@*) (*@$\ell_1$@*)) (h(*@$\ell'$@*) : (*@$\ell_1$@*) (*@$\leq$@*) (*@$\ell'$@*)) (h(*@$\ell$@*) : (*@$\ell'$@*) (*@$\leq$@*) (*@$\ell$@*))
    : flagDensity(*@$_1$@*) (*@$\sigma$@*) F(*@$_1$@*) G =
      (*@$\sum$@*) G' : Flag (*@$\sigma$@*) (Fin (*@$\ell'$@*)),
        flagDensity(*@$_1$@*) (*@$\sigma$@*) F(*@$_1$@*) G' * flagDensity(*@$_1$@*) (*@$\sigma$@*) G' G
\end{lstlisting}

\subsection{The Flag Algebra}

The algebraic part of the formalization works with flag types whose label type
is \lean{Fin $n_0$}.  In the source file, \lean{$n_0$} and \(\sigma\) are
ambient variables for this subsection; below, we keep displaying them in each
signature.
...
\begin{lstlisting}
abbrev FlagVector (n(*@$_0$@*) : (*@$\mathbb{N}$@*))
    ((*@$\sigma$@*) : FlagType (Fin n(*@$_0$@*))) : Type :=
  FinFlag n(*@$_0$@*) (*@$\sigma$@*) (*@$\to_0$@*) (*@$\mathbb{R}$@*)

def basisVector {n(*@$_0$@*) : (*@$\mathbb{N}$@*)} ((*@$\sigma$@*) : FlagType (Fin n(*@$_0$@*)))
    (F : FinFlag n(*@$_0$@*) (*@$\sigma$@*)) : FlagVector n(*@$_0$@*) (*@$\sigma$@*) :=
  Finsupp.single F 1
\end{lstlisting}
...
noncomputable def flagExpansion {n(*@$_0$@*) : (*@$\mathbb{N}$@*)}
  ...
  (*@$\sum$@*) F' : FlagWithSize n(*@$_0$@*) (*@$\ell$@*) (*@$\sigma$@*),
...
noncomputable def flagMulWithSize {n(*@$_0$@*) : (*@$\mathbb{N}$@*)}
  ...
  (*@$\sum$@*) G : FlagWithSize n(*@$_0$@*) (*@$\ell$@*) (*@$\sigma$@*),
...
noncomputable def downwardNormalizingFactor_labeledGraph
  ...
  isomor(*@\texttt{ph}@*)ismCount (*@$\sigma$@*) G / num_of_all_injections
...
def forbidLE {n(*@$_0$@*) : (*@$\mathbb{N}$@*)} ((*@$\sigma$@*) : FlagType (Fin n(*@$_0$@*)))
  ...
  forall (phi0 : PositiveHom 0 (*@$\emptyt$@*)), phi0 (*@$\langle\sigma\rangle_0$@*) > 0 ->
    phi0 (*@$\llbracket$@*)basisVector (*@$\emptyt$@*) H(*@$\rrbracket_0$@*) = 0 ->
    P[phi0] {phi : PositiveHomSpace n(*@$_0$@*) (*@$\sigma$@*) | phi f <= phi g} = 1
\end{lstlisting}
...
\lean{phi0 $\langle\sigma\rangle_0$ > 0} records
...
theorem exists_probMeasure_extend_emptyType_positiveHom
    {n(*@$_0$@*) : (*@$\mathbb{N}$@*)} ((*@$\sigma$@*) : FlagType (Fin n(*@$_0$@*)))
    {phi0 : PositiveHom 0 (*@$\emptyt$@*)}
    (h_sigma : phi0 (*@$\langle\sigma\rangle_0$@*) > 0) :
  exists P : ProbabilityMeasure (PositiveHomSpace n(*@$_0$@*) (*@$\sigma$@*)),
    forall f : FlagAlgebra n(*@$_0$@*) (*@$\sigma$@*),
      integral (fun phi => phi f) P =
        phi0 (*@$\llbracket$@*)f(*@$\rrbracket_0$@*) /
          phi0 (*@$\llbracket$@*)(1 : FlagAlgebra n(*@$_0$@*) (*@$\sigma$@*))(*@$\rrbracket_0$@*)
\end{lstlisting}
