...
term by term, so the downward identities needed in the certificate proofs of
\Cref{sec:flagmatic} can be established computationally rather than by separate
counting arguments.
