...
For $N=5$, the times were measured using \lean{native\_decide}.
...
\begin{table}[h]
  ...
  \begin{tabular}{lccrl}
    ...
    \midrule
    Mantel ($K_2$, induced route)    & $K_3$ & 3 &    $15^\dagger$ &  30 \\
    Mantel ($K_2$, H-free route)     & $K_3$ & 3 &    $15^\dagger$ &  19 \\
    $P_3$ density                    & $K_3$ & 3 &    $15^\dagger$ &  19 \\
    $C_4$ density                    & $K_3$ & 4 &   $210^\dagger$ &  84 \\
    Edge density ($K_4$-Tur\'an)     & $K_4$ & 4 &   $390^\dagger$ & 149 \\
    \midrule
    Erd\H{o}s pentagon ($C_5$)       & $K_3$ & 5 &  $2832^\ddagger$ & 147 \\
    Edge density ($K_5$-Tur\'an)     & $K_5$ & 5 & $10332^\ddagger$ & 378 \\
    Edge density ($C_5$-free)        & $C_5$ & 5 &  $8172^\ddagger$ & 590 \\
    \bottomrule
  \end{tabular}
\end{table}
