...
flag types require 1,800; 672; and 360 pair-density theorems, respectively.
Lean checks all 2,832 identities by \lean{decide +kernel} and then uses the
...
hosts of about seven or eight vertices.  The formal pipeline reaches its
