...
All the definitions and results stated in this section have been formalized in
Lean.  The principal statements appear as
\lean{support\_criterion}, \lean{blowupClosed\_root\_plantable},
\lean{heredClass\_emptyType\_rootPlantable}, and
\lean{c4free\_not\_rootPlantable}.  The Lean files for this meta-theory were
not written manually: Claude agents generated them in an autoformalization
workflow from an already-developed mathematical account and its theorem
targets.  Lean checks the resulting proof terms, and the development builds
without incomplete proofs.
...
including finite planting criteria, further positive and negative examples,
pinning obstructions, and the extension of ensemble semantics to
non-hereditary constraints.  The role of the present section is to record the
mathematics that arose directly from the design of \lean{forbidLE}: a soundness
theorem, an exact completeness criterion, and a broad structural theorem
