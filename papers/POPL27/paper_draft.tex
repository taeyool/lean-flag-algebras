...
orders, one triangle-free graph whose normalized count of induced copies of
...
\end{lstlisting}
\lean{blowUp G n} is the $n$-fold blow-up of an arbitrary base graph $G$: its
...
in the
blow-up: a choice function $g$ is sent to the subgraph induced on the five
...
applied to the edge flag labeled at one endpoint.
...
theorem.  These statements illustrate that the specification layer
