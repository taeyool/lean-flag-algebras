...
finite labeled pattern.  Our investigation proves a root-plantability criterion
...
\begin{proof}
  ...
  $[F] \leq c \cdot \mathbf{1}$ means $\phi([F]) \leq c$ for every~$\phi \in \poshom{\emptyset}$, a contradiction.
\end{proof}
...
\begin{proof}[Proof sketch]
  ...
  \[
    ...
    \;\geq\; 0.
  \]
  Since $\phi_0$ was arbitrary, we have $0 \leq \llbracket f \rrbracket_\sigma$.
\end{proof}
