...
respects isomorphism classes of the input $\sigma$-flags.  Extending bilinearly to all
...
limiting objects of convergent
sequences of host $\sigma$-flags.  The semantic non-negativity cone
...
\lean{Flag}~\(\sigma\)~\lean{V}, \(\llbracket G\rrbracket\) is the \(\sigma\)-flag
...
$\sigma$-flags.  The reflection layer computes the underlying $\emptyset$-flag and its
