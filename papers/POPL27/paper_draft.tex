...
nontrivial bounds for sparse graphs of bounded maximum degree.  Under this normalization the exact density-expansion
identity behind the classical quotient construction holds only up to an
error bounded by a constant multiple of $1/\Delta$, so no quotient is taken: their algebra is defined
...
triangle-free graphs and on the strong chromatic index.  Independently,
