...
$S\subseteq V(G)$ with $|S|=|V(P)|$ and the restriction of $G$ to $S$, denoted $G[S]$, is isomorphic to $P$, and
...
representations in Lean to the quotient definitions in Lean by adequacy theorems, verifies
...
with graph limits and then imposes the constraint a posteriori by testing inequalities on
...
to an extremal-density or equality slice. Our formalization supports the ensemble semantics.
...
externally generated rational flag-algebra-certificate data into Lean-checked algebraic
...
generalization beyond hereditary constraints. The non-standard ensemble semantics is
followed by our formalization.
