...
the entire ``intelligence'' of the generator; why none of it has to be trusted is
the subject of Section~\ref{sec:flagmatic-trust}.
...
tactic of Sections~\ref{sec:flagmatic-gen}--\ref{sec:flagmatic-close}.  A
