...
A semidefinite-programming (SDP) solver proposes finite data intended to satisfy these conditions, and
the flag algebra framework explains why any data that pass the checks establish
the desired bound for the whole class.
