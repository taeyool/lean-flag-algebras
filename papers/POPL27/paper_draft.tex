...
\begin{figure}[t]
  ...
  ordinary graphs, of sizes 2, 3, and 5.  \emph{Bottom row}: flags of the
  unique one-vertex flag type $\sigma$.  The filled vertex carries label~1,
  and the open vertices are unlabeled.  The flags $P_3^\bullet$ and
...
\[
  \phi_0([F])=0
  \qquad
  \text{for every empty-type flag } F
