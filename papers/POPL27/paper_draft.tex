...
memory for all seven compiler examples, compiled with Lean~4 (v4.27.0) on an
...
largest ($K_5$-Tur\'an and $C_5$-free) only \lean{native\_decide} was measured.
...
otherwise highly repeatable (standard deviation below $0.5\%$ of the mean in
every configuration except the pentagon under kernel evaluation, at $3.9\%$).
Two individual runs---one $C_4$-density \lean{native\_decide} run and one
pentagon \lean{decide +kernel} run---were excluded as system-contention stalls,
each identified by an anomalous wall-clock time with an unchanged peak resident
set; the remaining four runs of those two configurations were averaged.
...
\begin{table}[h]
  ...
  \caption{End-to-end Lean compilation time (mean of five runs, $\pm$ sample
    ...
    ``Lemmas'' is the total count of generated \lean{flagDensity\char`\_2} simp
  ...
  \begin{tabular}{lccr rr rr}
    ...
    \midrule
    Mantel ($K_2$)               & $K_3$ & 3 &    15 & $14.1\pm0.3$   &  2.4 & $11.5\pm0.1$  & 2.0 \\
    $P_3$ density                & $K_3$ & 3 &    15 & $13.3\pm0.1$   &  2.4 & $11.1\pm0.0$  & 2.0 \\
    $C_4$ density                & $K_3$ & 4 &   210 & $74.4\pm0.1$   &  8.2 & $19.8\pm0.2$  & 2.3 \\
    Edge density ($K_4$-Tur\'an) & $K_4$ & 4 &   390 & $133.3\pm0.3$  & 11.2 & $27.9\pm0.1$  & 2.5 \\
    Erd\H{o}s pentagon ($C_5$)   & $K_3$ & 5 &  2832 & $2786\pm108$   & 42.3 & $123.4\pm0.5$ & 4.2 \\
    Edge density ($K_5$-Tur\'an) & $K_5$ & 5 & 10332 & ---            & ---  & $342.6\pm0.6$ & 8.1 \\
    Edge density ($C_5$-free)    & $C_5$ & 5 &  8172 & ---            & ---  & $539.6\pm0.5$ & 8.6 \\
    \bottomrule
  \end{tabular}
\end{table}
