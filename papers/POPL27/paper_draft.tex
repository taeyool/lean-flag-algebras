...
flags, algebras, and positive homomorphisms.  As \Cref{sec:forbidden}
explains, this difference is not purely organizational: for intermediate
statements about labeled flags, the two approaches need not give the same
notion of validity.  Our case studies, however, use \lean{forbidLE} to derive
final unlabeled Tur\'an bounds, and the transfer theorem proves that this use
is sound.
...
be reused across forbidden graphs; fixing the forbidden graphs at the outset
may make arguments specific to one extremal problem more direct.  Comparing
the total cost would require carrying comparable case studies through both
designs.
...
representation throughout and evaluate its definitions directly; as
\Cref{sec:lessons} discusses, this was not practical for our largest case
study.  Another is to use a concrete, canonical representation throughout;
