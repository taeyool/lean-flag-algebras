...
pair case:
\begin{lstlisting}
variable {T W U(*@$_0$@*) U(*@$_1$@*) : Type} [Fintype T] [Fintype W] [DecidableEq W] {(*@$\sigma$@*) : FlagType T}
         [Fintype U(*@$_0$@*)] [DecidableEq U(*@$_0$@*)] [Fintype U(*@$_1$@*)] [DecidableEq U(*@$_1$@*)]
         {t : (*@$\mathbb{N}$@*)} {Vl : Fin t (*@$\to$@*) Type} [FintypeList Vl] [DecidableEqList Vl]
...
equal (\lean{Fintype T} is a subsingleton, and likewise \lean{DecidableEq T}).  The bridging lemma
...
enumeration and decidability instances that its \lean{FintypeList} and
\lean{DecidableEqList} hypotheses supply for the component types, and
\lean{congr!} resolves those.
