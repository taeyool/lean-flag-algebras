...
ensemble inequality.  This one-way implication is sufficient to transfer the
flag-algebra inequalities formalized here to the final unlabeled Tur\'an bounds.
...
terms.  Asking how it relates to Razborov's original semantics turned into
mathematics of its own: quotient validity always implies ensemble validity, and
