...
\item \emph{Machine-checked extremal bounds}: seven compiled Tur\'an-type upper
  bounds.  For two of them---Mantel's theorem and the Erd\H{o}s pentagon
  theorem---we also prove matching lower-bound constructions directly in Lean,
  yielding exact theorems.  To our knowledge, this gives the first
  machine-checked proof of the Erd\H{o}s pentagon theorem, whose known proofs
  all use flag algebras.
