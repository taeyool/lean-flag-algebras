...
the interface through which this development counts.  The sets this development counts are described
...
density and multiplication identities; a final tactic then reads the
certificate, checks its remaining claims, and assembles a complete proof of a
theorem stated in the source file.  Underlying the pipeline are a
