...
\item \emph{Machine-checked theorems}: seven compiled Tur\'an-type upper
  ...
  directly in the library, these yield, to our knowledge, the first
  machine-checked proof of the pentagon theorem, whose known proofs all
  use flag algebras (\Cref{sec:results,sec:lowerbounds}).
\end{itemize}
