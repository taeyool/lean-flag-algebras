...
\newcommand{\boldparagraph}[1]{\paragraph{\textnormal{\textbf{#1}}}}
...
asymptotic upper bound for every graph in the class under consideration.
...
\boldparagraph{Two semantics for forbidden subgraphs.}
...
\boldparagraph{Which engineering obstacles are Lean-specific?}
