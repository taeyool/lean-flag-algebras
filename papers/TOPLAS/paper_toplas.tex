...
and \lean{S1} consist of tuples of pairwise-disjoint sets of unlabeled host
vertices that induce \lean{Fl} and \lean{Fl.permute $\pi$}, respectively.  The
mathematical step is the reindexing bijection, and the named instances ensure
that the resulting cardinality equality rewrites the counts occurring in the
density definition.
