...
theorem proved once, mathematically, in \btt{Generate.lean}:
\begin{itemize}
...
\btt{Generate.lean} contained a pure Lean enumeration of one canonical graph per
...
\btt{genFlagData k m n} to \btt{Generate.lean}: for each underlying graph (in the
...
The supporting math, all added to \btt{Generate.lean}, was small and low-risk because
