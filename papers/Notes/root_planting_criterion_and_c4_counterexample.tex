...
Fix the constants first.  Let $C_m$ be a constant, depending only on $m$ (with $k=|\sigma|$ fixed), large enough for the two sampling estimates used for (iii) below.  Choose
...
\[
  ...
  =2mk\lambda,
\]
which is $O_m(\lambda)$ (indeed at most $2m^2\lambda$, since $k\le m$).  Second, once the sample lies
