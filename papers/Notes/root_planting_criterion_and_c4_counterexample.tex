...
\section{Finite planting and the \texorpdfstring{$C_5$}{C5}-free class}
...
\subsection{The root-plantable types}
...
obstructs; see \cref{sec:c5-edge}.)  Throughout, $C_5$-free means containing no $C_5$ as a (not
necessarily induced) subgraph, the densest such graphs being complete bipartite.
