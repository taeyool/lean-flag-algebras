...
property of the class assumed.  One first creates many possible embeddings of the labelled
...
\[
  ...
  \{\chi\in X_\sigma:
    |\chi(F_i)-\psi(F_i)|<\eps\text{ for all }i\}.
\]
Pick an integer $m\ge|\sigma|$ bounding the sizes of the $F_i$. Also,
...
Let $(G,\theta)$ be a $\sigma$-flag with $G\in\K$ and $n:=|G|\ge n_0$, and let
