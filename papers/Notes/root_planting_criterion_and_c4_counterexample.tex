...
$(\ell-k)\lambda+O_m(\operatorname{err}_N)$.  Conditional on avoiding the
planted clone classes, the sample lands among the non-labelled clone classes
with probabilities proportional to their normalised sizes; these probabilities
are all $1/(n-k)+O_m(\operatorname{err}_N)$ because the total non-labelled mass
is $1-\lambda\ge1/2$.  Therefore the probability that two sampled vertices
