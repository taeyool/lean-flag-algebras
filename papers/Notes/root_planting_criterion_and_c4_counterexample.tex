...
\]
Consequently, allowing labelled terms \(s\in\A^\sigma[\T_1]\) that are non-negative only on
$S_\sigma$ cannot improve any density bound except possibly at the level of exact finite
certificates using non-empty types.
\end{theorem}
