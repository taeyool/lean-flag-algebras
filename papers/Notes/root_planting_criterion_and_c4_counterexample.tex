...
$k$ labelled vertices.  Write $\Emb_\sigma(H)$ for the set of embeddings
$\sigma\to H$.  We say that $\K$ has the \emph{finite local planting property at
...
property. Every finite $\sigma$-flag $(G,\theta)$ in $\K$ with $|G|\ge n_0$ admits a graph
