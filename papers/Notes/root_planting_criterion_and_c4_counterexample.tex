...
$C_f=C_m\sum_r |a_r|$. Before starting the proof, we point out that 
...
$\operatorname{err}_N$.  Consider the following finite random labelling
experiment on the unlabelled graph $B_N$: choose uniformly from all induced
embeddings $\widehat\theta:\sigma\to B_N$, where the labels of $\sigma$ are kept
in their prescribed order.  If either $k=0$, or $k>0$ and
...
it is invisible to the densities of fixed rooted flags.
