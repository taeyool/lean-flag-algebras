...
they exclude the sparse endpoint of the admissible density interval.
\end{abstract}
...
admissible density interval outright (\cref{cor:p4-lower-endpoint}).
...
$\alpha_r^-$ unconditionally (\cref{cor:p4-lower-endpoint})---settling the
...
$W$ on $L^2[0,1]$: a self-adjoint Hilbert--Schmidt operator, with real nonzero
eigenvalues $(\lambda_i)_{i\ge1}$ listed with multiplicity in decreasing modulus,
$|\lambda_1|\ge|\lambda_2|\ge\cdots\to0$, orthonormal eigenfunctions $(e_i)$,
...
$[\alpha_r^-,\alpha_r^+]$ is unattainable.
