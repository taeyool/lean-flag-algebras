...
balanced complete tripartite extremal graphon.  The same extraction works for the
parametric $K_{r+1}$-free $P_4$ certificate: equality forces the $r$-partite local
laws, and the only remaining external input needed to identify the whole graphon is the
classical equality case of Zykov's clique-density theorem.
\end{abstract}
...
tripartite limit by the equality case of Turán's theorem.  Finally, the parametric
\texttt{CompleteGraphFreeP4} certificate gives the corresponding $r$-partite local
equations for every $r\ge3$; for $r\ge4$, the equality case of Zykov's
$K_4$-density theorem turns these equations into a full recovery of the balanced
complete $r$-partite limit.
...
$K_4$ density among $K_{r+1}$-free graphons.  The imported equality case of Zykov's
