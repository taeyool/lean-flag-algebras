...
expansion, and the whole lemma closes with the single tactic
\texttt{flag\_expand\_hfree}, which itself dispatches between Route~A and
Route~B on whether the forbid graph is complete. There is no manual
