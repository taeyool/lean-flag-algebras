...
## Retrieved Evidence
- [theorem] Mantel_theorem @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:13 :: theorem Mantel_theorem
- [theorem] Mantel_theorem' @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:55 :: theorem Mantel_theorem'
- [lemma] Flag_3_0_0_3_eq @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:61 :: lemma Flag_3_0_0_3_eq
- [lemma] Flag_2_0_0_1_eq @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:77 :: lemma Flag_2_0_0_1_eq
- [lemma] extremal_density_K3_ge @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:93 :: lemma extremal_density_K3_ge
- [theorem] Turan_density_K3 @ LeanFlagAlgebras/MantelTheorem/MantelTheorem.lean:164 :: theorem Turan_density_K3
- [theorem] ErdosPentagon_Turan_upperBound @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:8 :: theorem ErdosPentagon_Turan_upperBound
- [def] blowUp @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:13 :: def blowUp
- [theorem] blowUp_adj_iff @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:21 :: theorem blowUp_adj_iff
- [theorem] blowUp_K3_free @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:28 :: theorem blowUp_K3_free
- [theorem] free_of_iso @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:54 :: theorem free_of_iso
- [lemma] fin_div_lt @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:68 :: lemma fin_div_lt
- [def] blowUp_fin @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:76 :: def blowUp_fin
- [def] blowUp_fin_iso @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:86 :: def blowUp_fin_iso
- [lemma] K3_free_C5 @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:97 :: lemma K3_free_C5
- [lemma] subgraphCount_blowUp_C5_ge @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:125 :: lemma subgraphCount_blowUp_C5_ge
- [theorem] generalizedExtremalNumber_K3_C5_ge @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:197 :: theorem generalizedExtremalNumber_K3_C5_ge
- [theorem] generalizedExtremalNumber_K3_C5_div_choose_ge @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:212 :: theorem generalizedExtremalNumber_K3_C5_div_choose_ge
- [theorem] ErdosPentagon_Turan_lowerBound @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:231 :: theorem ErdosPentagon_Turan_lowerBound
- [theorem] ErdosPentagon_Turan @ LeanFlagAlgebras/ErdosPentagon/ErdosPentagon.lean:250 :: theorem ErdosPentagon_Turan
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:41 :: # Supports names like flags_5_3_1.json or graphs_5.json.
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:60 :: if isinstance(raw, dict) and "flags" in raw:
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:64 :: for idx, item in enumerate(raw["flags"]):
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:85 :: "Unsupported JSON format. Expected either list-of-graphs or object with key 'flags'."
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:90 :: # Example: flags_5_3_1.json -> 5_3_1
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:91 :: m = re.search(r"flags_(\d+_\d+_\d+)\.json$", path.name)
- [text] line @ LeanFlagAlgebras/ErdosPentagon/Densities/calculate_densities.py:185 :: def density_p_f1_f2_given_g(host: GraphRecord, f1: GraphRecord, f2: GraphRecord) -> Fraction:
