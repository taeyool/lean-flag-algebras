...
def generate_flags_with_type(n, k, type_index):
    ...
    """
    if n < k:
        raise ValueError("The number of vertices 'n' in the flag must be greater than or equal to 'k'.")
    ...
    print(f"[{output_filename}] Saved successfully: Contains type info and {len(flags_list)} non-isomorphic flags.")

if __name__ == "__main__":
    # Example usage:
    generate_flags_with_type(n=4, k=2, type_index=1)