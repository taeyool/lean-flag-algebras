...
--     LeanFlagAlgebras/Flagmatic/Certificates/K5turan_reduced_cert.json \
--     LeanFlagAlgebras/Flagmatic/K5turanReduce.lean --namespace K5turanReduce --native-decide --force
...
lemma K5turan_reduced_flagAlgebra_expand_under_forbid
...
Bound: '3/4'. -/
theorem K5turan_reduced_flagAlgebra
  ...
  simp only [add_assoc]
  rw [forbidLEWith_rw_left_add_right K5turan_reduced_flagAlgebra_expand_under_forbid]
