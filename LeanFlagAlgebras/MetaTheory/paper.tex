...
particular every pinning witness $F-c\,\one_\sigma$, and every flag-multiple
$(F-c\,\one_\sigma)\,h$, unlabels to zero.  Consequently $\avg{\cdot}{\sigma}$ depends
...
\]
If $\phi_0(\brak\sigma)=0$, then every unlabelled graph appearing in
$\avg{s}{\sigma}$ contains an embedding of $\sigma$, hence has $\phi_0$-density $0$ by
