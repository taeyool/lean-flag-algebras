...
$v$, and $B_j\in\K$.  Each $B_j$ is a blow-up of $G_t$ in the sense of
\cref{lem:planted-estimate,lem:true-planted-estimate}: its between-class adjacencies are
those of $G_t$ and the interiors $H_v^{(j)}$ are never observed on the good event.  Thus
the planted estimate, the planted-mass bound, and the positive lower bound on the
$\sigma$-type density all hold for $B_j$ exactly as for the independent and complete
blow-ups, with uniform clone sizes $j$.  The closed-cylinder and Portmanteau argument of
