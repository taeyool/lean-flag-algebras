...
Also, $Q_\sigma$ is closed in $X_\sigma$ by \cref{prop:constrained-intrinsic}; more
explicitly, it is cut out by the equations $\chi(F)=0$ for forbidden flags $F$.  Hence
Tietze's extension theorem applies, and
