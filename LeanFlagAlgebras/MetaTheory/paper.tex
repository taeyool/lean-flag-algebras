...
Three classical theorems enter this section as unproved external inputs: the
...
\cref{thm:relative-mantel}); the equality case of Zykov's $K_4$-density theorem
(uniqueness of the same graphon as the extremiser of the induced-$K_4$-density bound,
...
equality case.  Consequently, the hypothesis of \cref{cor:parametric-p4-turan-recovery}
can be weakened from the full equality case of Zykov's theorem to the single scalar
statement that every element of $Y_r$ has edge density $\frac{r-1}r$.
\end{corollary}
